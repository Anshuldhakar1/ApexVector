...
from apexvec.types import AdaptiveConfig, VectorizationError
from apexvec.raster_ingest import ingest, IngestResult
from apexvec.region_decomposer import decompose
from apexvec.region_classifier import classify
from apexvec.strategies.router import vectorize_all_regions
from apexvec.topology_merger import merge_topology
from apexvec.svg_optimizer import regions_to_svg, get_svg_size
from apexvec.perceptual_loss import compute_ssim, mean_delta_e
from apexvec.debug_utils import (
...
class UnifiedPipeline:
    ...
    def process(self, input_path: Union[str, Path], output_path: Optional[Union[str, Path]] = None) -> str:
        ...
        # Count by type
        from apexvec.types import RegionKind
        type_counts = {}
        for r in regions:
