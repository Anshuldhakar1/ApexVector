...
from apexvec.types import Region, AdaptiveConfig
from apexvec.compute_backend import slic_superpixels
from apexvec.debug_utils import audit_regions_at_extraction
