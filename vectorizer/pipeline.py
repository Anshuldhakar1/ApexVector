...
from vectorizer.svg_optimizer import regions_to_svg, get_svg_size, generate_optimized_svg, generate_ultra_compressed_svg, generate_symbol_optimized_svg, generate_merged_svg, generate_extreme_svg
...
class UnifiedPipeline:
    ...
    def process(self, input_path: Union[str, Path], output_path: Optional[Union[str, Path]] = None, optimize: bool = True) -> str:
        ...
        elif optimize == 'extreme':
            svg_string = generate_extreme_svg(
                vector_regions,
                ingest_result.width,
                ingest_result.height
            )
